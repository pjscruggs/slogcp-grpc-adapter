...
class WorkflowPolicyTests(unittest.TestCase):
    ...
    def test_preflight_uses_full_history_and_requires_the_adapter_example(self) -> None:
        ...
        self.assertIn("exactly the tracked .examples/adapter/go.mod", GO_PLAN)
    ...
    def test_tools_are_built_before_restoring_the_module_compiler(self) -> None:
        ...
        example = VALIDATION.split("  example_validation:", 1)[1].split("  adapter_local_validation_policy:", 1)[0]
        for source, setup in ((root, "Set up preferred root Go runtime"), (example, "Set up adapter example Go runtime")):
